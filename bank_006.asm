...
SECTION "ROM Bank $006", ROMX[$4000], BANK[$6]
    ...
    nop                                           ; $4033: $00
    nop                                           ; $4034: $00
    ld bc, $0202                                  ; $4035: $01 $02 $02
    ld [bc], a                                    ; $4038: $02
    ld bc, $0100                                  ; $4039: $01 $00 $01
    ld [bc], a                                    ; $403c: $02
    ld bc, $0102                                  ; $403d: $01 $02 $01
    ld [bc], a                                    ; $4040: $02
    ld [bc], a                                    ; $4041: $02
    ld [bc], a                                    ; $4042: $02
    ld [bc], a                                    ; $4043: $02
    ...
    nop                                           ; $4052: $00
    ld bc, $0202                                  ; $4053: $01 $02 $02
    ld [bc], a                                    ; $4056: $02
    ld bc, $0102                                  ; $4057: $01 $02 $01
    ld bc, $0102                                  ; $405a: $01 $02 $01
    nop                                           ; $405d: $00
    nop                                           ; $405e: $00
    nop                                           ; $405f: $00
    ld bc, $0002                                  ; $4060: $01 $02 $00
    nop                                           ; $4063: $00
...
Jump_006_4500:
    ...
    ld bc, $0102                                  ; $4514: $01 $02 $01
    ld [bc], a                                    ; $4517: $02
    inc bc                                        ; $4518: $03
    inc bc                                        ; $4519: $03
    ld bc, $0102                                  ; $451a: $01 $02 $01
    ld bc, $0101                                  ; $451d: $01 $01 $01
    ld bc, $0202                                  ; $4520: $01 $02 $02
    ld [bc], a                                    ; $4523: $02
    ld [bc], a                                    ; $4524: $02
    ld [bc], a                                    ; $4525: $02
    inc bc                                        ; $4526: $03
    ...
    ld bc, $0101                                  ; $4539: $01 $01 $01
    ld bc, $0101                                  ; $453c: $01 $01 $01
    ld bc, $0201                                  ; $453f: $01 $01 $02
    ld bc, $0103                                  ; $4542: $01 $03 $01
    ld bc, $0101                                  ; $4545: $01 $01 $01
    ld bc, $0101                                  ; $4548: $01 $01 $01
    ld bc, $0101                                  ; $454b: $01 $01 $01
    ld [bc], a                                    ; $454e: $02
    ld bc, $0103                                  ; $454f: $01 $03 $01
    ld [bc], a                                    ; $4552: $02
    ld [bc], a                                    ; $4553: $02
...
Call_006_46b3:
    ...
    call Call_000_0b43                            ; $46b7: $cd $43 $0b
    pop bc                                        ; $46ba: $c1
...
Call_006_47c7:
    ...
    ld a, $09                                     ; $47d2: $3e $09
    call Call_000_0b43                            ; $47d4: $cd $43 $0b
    ldh a, [$a7]                                  ; $47d7: $f0 $a7
    or a                                          ; $47d9: $b7
    ...
    ld a, $09                                     ; $47e6: $3e $09
    call Call_000_0b43                            ; $47e8: $cd $43 $0b
    ldh a, [$a7]                                  ; $47eb: $f0 $a7
    sla a                                         ; $47ed: $cb $27
...
jr_006_4ba6:
    ...
    xor a                                         ; $4bc1: $af
    call Call_000_0b16                            ; $4bc2: $cd $16 $0b
    ld a, $01                                     ; $4bc5: $3e $01
    ldh [$ac], a                                  ; $4bc7: $e0 $ac
    ld a, $06                                     ; $4bc9: $3e $06
    ldh [$ad], a                                  ; $4bcb: $e0 $ad
...
jr_006_501a:
    ...
    xor a                                         ; $5027: $af
    call Call_000_0b16                            ; $5028: $cd $16 $0b
    ret                                           ; $502b: $c9


    db $00

    ld bc, $0902                                  ; $502d: $01 $02 $09
    ld [bc], a                                    ; $5030: $02
    nop                                           ; $5031: $00
    ld bc, $0109                                  ; $5032: $01 $09 $01
    ld [bc], a                                    ; $5035: $02
    nop                                           ; $5036: $00
    add hl, bc                                    ; $5037: $09
...
jr_006_5319:
    ...
    ld a, $0a                                     ; $538c: $3e $0a
    call Call_000_0b43                            ; $538e: $cd $43 $0b
    push hl                                       ; $5391: $e5
    push de                                       ; $5392: $d5
    push bc                                       ; $5393: $c5
    ld a, $16                                     ; $5394: $3e $16
    ...
    ld a, $0a                                     ; $53a2: $3e $0a
    call Call_000_0b43                            ; $53a4: $cd $43 $0b
    pop bc                                        ; $53a7: $c1
    pop de                                        ; $53a8: $d1
    pop hl                                        ; $53a9: $e1
    ldh a, [$aa]                                  ; $53aa: $f0 $aa
...
jr_006_54a9:
    ...
    ld bc, $0101                                  ; $5508: $01 $01 $01

    db $00, $00

    nop                                           ; $550d: $00
    nop                                           ; $550e: $00
    ld bc, $0101                                  ; $550f: $01 $01 $01
...
jr_006_601b:
    ...
    ld a, $0a                                     ; $608e: $3e $0a
    call Call_000_0b43                            ; $6090: $cd $43 $0b
    push hl                                       ; $6093: $e5
    push de                                       ; $6094: $d5
    push bc                                       ; $6095: $c5
    ld a, $16                                     ; $6096: $3e $16
    ...
    ld a, $0a                                     ; $60a4: $3e $0a
    call Call_000_0b43                            ; $60a6: $cd $43 $0b
    pop bc                                        ; $60a9: $c1
    pop de                                        ; $60aa: $d1
    pop hl                                        ; $60ab: $e1
...
Call_006_6386:
    ...
    db $45, $73, $4e, $73, $c0, $73, $42, $74, $b4, $78, $f8, $79, $00, $7a, $d1, $7f
    db $54, $72, $26, $72
...
jr_006_7341:
    ...
    xor a                                         ; $7366: $af
    call Call_000_0b16                            ; $7367: $cd $16 $0b
...
Jump_006_77d7:
    ...
    ld a, $0a                                     ; $77ff: $3e $0a
    call Call_000_0b43                            ; $7801: $cd $43 $0b
