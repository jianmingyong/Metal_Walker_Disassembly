...
Jump_000_0320:
    ld a, [wGameTimeLsb]                                 ; $0320: $fa $ea $c1
    add $01                                       ; $0323: $c6 $01

Jump_000_0325:
    ld [wGameTimeLsb], a                                 ; $0325: $ea $ea $c1
    ld a, [wGameTimeMsb]                                 ; $0328: $fa $eb $c1
    adc $00                                       ; $032b: $ce $00
    ld [wGameTimeMsb], a                                 ; $032d: $ea $eb $c1
    ret                                           ; $0330: $c9
...
Call_000_0de6:
    ...
    ld a, $ff                                     ; $0dec: $3e $ff
    call WriteToRegisterHLFromA                   ; $0dee: $cd $16 $0b
    ld hl, $c0eb                                  ; $0df1: $21 $eb $c0
    ld bc, $0040                                  ; $0df4: $01 $40 $00
    ld a, $ff                                     ; $0df7: $3e $ff
    call WriteToRegisterHLFromA                   ; $0df9: $cd $16 $0b
...
Jump_000_2801:
    ...
    ld a, $00                                     ; $280d: $3e $00
    call WriteToRegisterHLFromA                   ; $280f: $cd $16 $0b
...
Call_000_2be0:
    ...
    xor a                                         ; $2be6: $af
    call WriteToRegisterHLFromA                   ; $2be7: $cd $16 $0b
